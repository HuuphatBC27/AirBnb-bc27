...
const Comments = ({ roomId }) => {
  ...
  const { data: comment } = useRequest(() => roomAPI.getCommentDetails(roomId));
            ...
            <div className="pe-3">
              <img
                ...
                src={
                  cmt.avatar
                    ? cmt.avatar
                    : "https://cdn5.vectorstock.com/i/1000x1000/73/64/text-user-icon-avatar-icon-vector-15887364.jpg"
                }
                alt=""
              />
            </div>
            <div className="d-flex w-100">
              <div>
                <p className="jobDetail-gig pb-2">
                  {cmt.tenNguoiBinhLuan ? cmt.tenNguoiBinhLuan : "Guest"}{" "}
                  <AiOutlineComment /> <span>99 Reviews</span>
                </p>
